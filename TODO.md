...
- [x] Phase 1: Ingest and analyze submodules (Aider, Claude Code, Pi-Mono, Rowboat).
- [x] Phase 2: Create Protocol Abstraction Layer (`schema/llm_api_protocol.json`).
...
- [ ] Phase 3: Implement LLM Router in Rust.
